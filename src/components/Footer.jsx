...
const Footer = () => {
  return (
    <footer className=" bottom-0 text-sm text-gray-500 bg-[#f2f2f2] w-full absolute">
      <div className="border-b px-8 py-2">
        <CountryLookup />
      </div>
      <div className="flex flex-col sm:flex-row justify-between items-center px-8 py-3 space-y-4 sm:space-y-0">
